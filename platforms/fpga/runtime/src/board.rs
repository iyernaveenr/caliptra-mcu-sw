...
use mcu_config_fpga::flash_partition_list_mm_flash_ctrl;
...
impl SyscallDriverLookup for VeeR {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            mcu_config_fpga::flash::DRIVER_NUM_MM_FLASH_CTRL => {
...
pub unsafe fn main() {
    ...
    let mux_mcu_mbox_flash =
        components::flash::FlashMuxComponent::new(&fpga_peripherals.mm_flash_ctrl).finalize(
            components::flash_mux_component_static!(crate::mm_flash_ctrl::MailboxFlashCtrl),
        );
    ...
    instantiate_flash_partitions!(
        ...
        board_kernel,
        mux_mcu_mbox_flash,
        crate::mm_flash_ctrl::MailboxFlashCtrl
    );
    romtime::println!("[mcu-runtime] flash partition on FPGA dummy flash controller initialized");
