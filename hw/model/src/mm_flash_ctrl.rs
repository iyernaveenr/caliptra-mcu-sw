...
impl ImaginaryFlashController {
    ...
    pub fn poll_mailbox_and_process(&self) {
        ...
        let page_num = self
            .mci
            .mcu_mbox0_csr_mbox_sram[0].get();
        let page_size_reg = self
            .mci
            .mcu_mbox0_csr_mbox_sram[1].get();
                ...
                if page_num < NUM_PAGES as u32 && page_size_reg as usize == PAGE_SIZE {
                    ...
                    if io_res.is_ok() {
                        for (i, chunk) in page_buf.chunks(4).enumerate() {
                            ...
                            self.mci
                                .mcu_mbox0_csr_mbox_sram[i].set(word);

                        }
                        self.mci
                            .mcu_mbox0_csr_mbox_dlen.set(PAGE_SIZE as u32);
            ...
            FlashOp::Write => {
                if page_num < NUM_PAGES as u32 && page_size_reg as usize == PAGE_SIZE {
                    ...
                    for i in 0..(PAGE_SIZE / 4) {
                        let word = self
                            .mci
                            .mcu_mbox0_csr_mbox_sram[2 + i].get();
                        for j in 0..4 {
        ...
        self.mci
            .mcu_mbox0_csr_mbox_target_status.set(
